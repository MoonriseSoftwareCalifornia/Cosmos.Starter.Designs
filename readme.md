...
* [Cosmos WPS Starter Layout](https://cosmos-layouts.moonrise.net/Layouts/cwps-boot/home.html) Author: Moonrise Software/MD Bootstrap, License: [MIT](https://cosmos-layouts.moonrise.net/Layouts/cwps-boot/LICENSE)
